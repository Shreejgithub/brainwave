    ...
    >
      <div className="container relative" ref={parallaxRef}>
        ...
        >
          ...
          >
            <div
              className="relative bg-n-8 rounded-
            [1rem]"
            >
              <div
              ...
              <div
                className="aspect-[33/40] rounded-b-
              [0.9rem] overflow-hidden md:aspect-[688/
          ...
          <div
            className="absolute -top-[54%] left-1/2 w-
          [234%] -translate-x-1/2 md:-top-[46%] md:w-
          [138%] lg:-top-[104%]"
          >
            <img
              src={heroBackground}
